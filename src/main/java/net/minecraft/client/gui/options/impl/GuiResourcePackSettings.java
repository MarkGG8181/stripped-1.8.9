...
import net.minecraft.client.gui.options.data.GuiResourcePackAvailable;
import net.minecraft.client.gui.options.data.GuiResourcePackSelected;
...
public class GuiResourcePackSettings extends GuiScreen {
