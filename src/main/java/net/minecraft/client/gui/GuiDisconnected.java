...
public class GuiDisconnected extends GuiScreen {
    ...
    public GuiDisconnected(GuiScreen screen, String reasonLocalizationKey, IChatComponent chatComp) {
        ...
        final String formattedMessage = message.getFormattedText();

        if (formattedMessage.contains("Cannot invoke") && formattedMessage.contains("because \"value\" is null")) {
            this.message = new ChatComponentText("The server you tried joining only allows premium users to join.");
        }
    }
