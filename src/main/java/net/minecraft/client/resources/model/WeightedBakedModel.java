...
public class WeightedBakedModel implements IBakedModel {
    ...
    public WeightedBakedModel(List<WeightedBakedModel.MyWeighedRandomItem> p_i46073_1_) {
        ...
        this.baseModel = ((WeightedBakedModel.MyWeighedRandomItem)p_i46073_1_.getFirst()).model;
    }
    ...
    public static class Builder {
        ...
        public IBakedModel first() {
            return ((WeightedBakedModel.MyWeighedRandomItem)this.listItems.getFirst()).model;
        }
    }
