...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func177077A(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
        ...
        else
        {
            ...
            int i = this.func177078A(itemstack);
            float f = 0.25F;
    ...
    private int func177078A(ItemStack stack)
    {
        int i = 1;
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        int i = this.func177077A(entity, x, y, z, partialTicks, ibakedmodel);
