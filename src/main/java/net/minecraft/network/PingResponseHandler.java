            ...
            if (bytebuf.readUnsignedByte() == 254) {
                ...
                switch (i) {
                    case 0:
                        ...
                        String s2 = "%s\u00a7%d\u00a7%d".formatted(new Object[]{minecraftserver.getMOTD(), Integer.valueOf(minecraftserver.getCurrentPlayerCount()), Integer.valueOf(minecraftserver.getMaxPlayers())});
                    ...
                    case 1:
                        ...
                        String s = "\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d".formatted(new Object[]{Integer.valueOf(127), minecraftserver.getMinecraftVersion(), minecraftserver.getMOTD(), Integer.valueOf(minecraftserver.getCurrentPlayerCount()), Integer.valueOf(minecraftserver.getMaxPlayers())});
                    ...
                    default:
                        ...
                        String s1 = "\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d".formatted(new Object[]{Integer.valueOf(127), minecraftserver.getMinecraftVersion(), minecraftserver.getMOTD(), Integer.valueOf(minecraftserver.getCurrentPlayerCount()), Integer.valueOf(minecraftserver.getMaxPlayers())});
