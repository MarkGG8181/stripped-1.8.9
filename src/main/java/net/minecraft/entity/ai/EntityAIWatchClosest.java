...
public class EntityAIWatchClosest extends EntityAIBase
{
    ...
    {
        return this.closestEntity.isEntityAlive() ? (this.theWatcher.getDistanceSqToEntity(this.closestEntity) > (double)(this.maxDistanceForPlayer * this.maxDistanceForPlayer) ? false : this.lookTime > 0) : false;
    }
