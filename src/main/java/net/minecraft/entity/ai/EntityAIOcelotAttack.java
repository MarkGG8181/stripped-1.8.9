...
public class EntityAIOcelotAttack extends EntityAIBase
{
    ...
    {
        return this.theVictim.isEntityAlive() ? (this.theEntity.getDistanceSqToEntity(this.theVictim) > 225.0D ? false : !this.theEntity.getNavigator().noPath() || this.shouldExecute()) : false;
    }
