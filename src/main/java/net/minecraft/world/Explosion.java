...
public class Explosion {
            ...
            if (!entity.isImmuneToExplosions()) {
                ...
                if (d12 <= 1.0D) {
                    ...
                    if (d13 != 0.0D) {
                        ...
                        if (entity instanceof EntityPlayer player && !player.capabilities.disableDamage) {
    ...
    public EntityLivingBase getExplosivePlacedBy() {
        return this.exploder == null ? null : (this.exploder instanceof EntityTNTPrimed etntp ? etntp.getTntPlacedBy() : (this.exploder instanceof EntityLivingBase elb ? elb : null));
    }
