...
import net.minecraft.world.biome.gen.impl.*;
import net.minecraft.world.biome.gen.impl.desert.BiomeGenDesert;
import net.minecraft.world.biome.gen.impl.desert.BiomeGenMesa;
import net.minecraft.world.biome.gen.impl.desert.BiomeGenMushroomIsland;
import net.minecraft.world.biome.gen.impl.general.BiomeGenHills;
import net.minecraft.world.biome.gen.impl.general.BiomeGenPlains;
import net.minecraft.world.biome.gen.impl.general.BiomeGenSavanna;
import net.minecraft.world.biome.gen.impl.general.BiomeGenSnow;
import net.minecraft.world.biome.gen.impl.trees.BiomeGenForest;
import net.minecraft.world.biome.gen.impl.trees.BiomeGenJungle;
import net.minecraft.world.biome.gen.impl.trees.BiomeGenTaiga;
import net.minecraft.world.biome.gen.impl.water.*;
...
public abstract class BiomeGenBase {
    ...
    public static final BiomeGenBase coldTaiga = new BiomeGenTaiga(30, 0).setColor(3233098).setBiomeName("Cold Taiga").setFillerBlockMetadata(5159473).setEnableSnow().setTemperatureRainfall(-0.5F, 0.4F).setHeight(height_MidPlains).func150563C();
    public static final BiomeGenBase coldTaigaHills = new BiomeGenTaiga(31, 0).setColor(2375478).setBiomeName("Cold Taiga Hills").setFillerBlockMetadata(5159473).setEnableSnow().setTemperatureRainfall(-0.5F, 0.4F).setHeight(height_LowHills).func150563C();
    ...
    public List<BiomeGenBase.SpawnListEntry> spawnableWaterCreatureList;
    public List<BiomeGenBase.SpawnListEntry> spawnableCaveCreatureList;
    ...
    protected BiomeGenBase setColor(int colorIn) {
        this.func150557A(colorIn, false);
        return this;
    }

    protected BiomeGenBase func150563C() {
