...
public class GenLayerRiver extends GenLayer
{
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i1 = 0; i1 < areaHeight; i1++)
        {
            ...
            {
                int k1 = this.func151630C(aint[j1 + 0 + (i1 + 1) * k]);
                int l1 = this.func151630C(aint[j1 + 2 + (i1 + 1) * k]);
                int i2 = this.func151630C(aint[j1 + 1 + (i1 + 0) * k]);
                int j2 = this.func151630C(aint[j1 + 1 + (i1 + 2) * k]);
                int k2 = this.func151630C(aint[j1 + 1 + (i1 + 1) * k]);
    ...
    private int func151630C(int p_151630_1_)
    {
