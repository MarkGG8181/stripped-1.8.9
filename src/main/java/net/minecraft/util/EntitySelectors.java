    ...
    public static class ArmoredMob implements Predicate<Entity>
    {
        ...
        public boolean apply(Entity p_apply_1_)
        {
            ...
            else
            {
                ...
                return entitylivingbase.getEquipmentInSlot(EntityLiving.getArmorPosition(this.armor)) != null ? false : (entitylivingbase instanceof EntityLiving el ? el.canPickUpLoot() : (entitylivingbase instanceof EntityArmorStand ? true : entitylivingbase instanceof EntityPlayer));
            }
        }
    }
}
