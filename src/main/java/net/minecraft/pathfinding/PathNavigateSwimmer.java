...
public class PathNavigateSwimmer extends PathNavigate
{
    ...
    {
        var movingobjectposition = this.worldObj.rayTraceBlocks(posVec31, new Vec3(posVec32.x, posVec32.y + (double)this.theEntity.height * 0.5D, posVec32.z), false, true, false);
