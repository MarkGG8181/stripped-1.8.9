...
public class PathNavigateGround extends PathNavigate {
    ...
    protected boolean isDirectPathBetweenPoints(Vec3 posVec31, Vec3 posVec32, int sizeX, int sizeY, int sizeZ) {
        var i = MathHelper.floor_double(posVec31.x);
        var j = MathHelper.floor_double(posVec31.z);
        var d0 = posVec32.x - posVec31.x;
        var d1 = posVec32.z - posVec31.z;
        var d2 = d0 * d0 + d1 * d1;
        ...
        var k = d0 < 0.0D ? -1 : 1;
        var l = d1 < 0.0D ? -1 : 1;
        var i1 = MathHelper.floor_double(posVec32.x);
        var j1 = MathHelper.floor_double(posVec32.z);
        var k1 = i1 - i;
        var l1 = j1 - j;
